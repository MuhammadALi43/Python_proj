...
__all__ = [
    'SREPrivate', 'SVSFIsXML', 'DISPID_SGRsCommitAndSave',
    'SpeechDiscardType', 'SPPHRASEREPLACEMENT', 'SPSHORTCUTTYPE',
    'eLEXTYPE_PRIVATE13', 'DISPID_SRGDictationUnload', 'SP_VISEME_2',
    'ISpeechTextSelectionInformation', 'UINT_PTR', 'SPCONTEXTSTATE',
    'DISPID_SGRs_NewEnum', 'ISpeechPhraseInfoBuilder',
    'SAFT8kHz8BitMono', 'DISPID_SPAsCount', 'DISPID_SRCState',
    'DISPID_SVDisplayUI', 'SAFT22kHz8BitMono', 'SPEI_SOUND_END',
    'DISPID_SPRuleChildren', 'SDKLCurrentUser', 'DISPID_SVSkip',
    'SPAS_PAUSE', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SREPropertyStringChange', 'SAFTADPCM_44kHzMono',
    'SPCATEGORYTYPE', 'DISPID_SRSCurrentStreamNumber', 'SVEPrivate',
    'DISPID_SRCCreateResultFromMemory', 'SPSHT_NotOverriden',
    'DISPID_SVPriority', 'SVSFVoiceMask', 'SITooLoud',
    'SPEI_RESERVED5', 'SVEAllEvents', 'SPEI_RECO_OTHER_CONTEXT',
    'SRTSMLTimeout', 'SRSEIsSpeaking', 'DISPID_SGRId',
    'DISPID_SRSSupportedLanguages', 'SAFT12kHz16BitMono',
    'STSF_FlagCreate', 'SPGS_ENABLED', 'SpAudioFormat',
    'SPGRAMMARWORDTYPE', 'DISPID_SDKEnumKeys', 'SPWORDLIST',
    'SAFTCCITT_ALaw_8kHzMono', 'SPBOOKMARKOPTIONS',
    'SpeechRecoEvents', 'SPPS_Modifier', 'ISpeechAudioBufferInfo',
    'SPPS_RESERVED2', 'SVP_20', 'SP_VISEME_7', 'ISpProperties',
    'SVP_9', 'SpeechTokenKeyUI', 'SDTProperty', 'DISPID_SPCLangId',
    'ISpResourceManager', 'SAFT8kHz16BitMono',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPBO_PAUSE', 'SVP_19',
    'SPSHT_EMAIL', 'DISPID_SPCIdToPhone', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SMSGetData', 'DISPID_SRSCurrentStreamPosition',
    'SGDSActiveUserDelimited', 'SRSInactiveWithPurge',
    'DISPID_SpeechPhraseRule', 'SPEVENTSOURCEINFO',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPPS_LMA',
    'SpeechPropertyResourceUsage', 'DISPID_SOTsItem',
    'SPSSuppressWord', 'DISPID_SFSClose', 'SVSFParseMask',
    'ISpRecoCategory', 'eLEXTYPE_RESERVED4', 'SAFT16kHz16BitStereo',
    'SPSFunction', 'SpeechCategoryRecoProfiles',
    'DISPID_SPRNumberOfElements', 'Speech_StreamPos_Asap',
    'DISPID_SAStatus', 'DISPID_SGRSTPropertyValue',
    'SpeechMicTraining', 'SVEWordBoundary', 'DISPID_SRRecognizer',
    'SVF_Stressed', 'SPSHORTCUTPAIR', 'DISPID_SGRSTsCount',
    'ISpRecoContext2', 'DISPID_SVAudioOutputStream',
    'DISPID_SpeechWaveFormatEx', 'SpeechAudioVolume',
    'SpInprocRecognizer', 'ISpLexicon', 'DISPID_SVEStreamEnd',
    'DISPID_SVGetAudioOutputs', 'SSSPTRelativeToCurrentPosition',
    'Speech_Max_Pron_Length', 'SSFMOpenForRead',
    'DISPID_SPRuleFirstElement', 'DISPID_SLPsCount',
    'SECNormalConfidence', 'DISPID_SRGCommit',
    'DISPID_SGRSAddWordTransition', 'SPGRAMMARSTATE',
    'SPPROPERTYINFO', 'SPPS_RESERVED3', 'SpeechAudioFormatGUIDWave',
    'ISpeechDataKey', 'ISpeechPhraseRules', 'SpeechDataKeyLocation',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPPHRASEPROPERTY',
    'SPEVENTENUM', 'DISPID_SRGId', 'SAFT22kHz8BitStereo', 'SPSVerb',
    'ISpeechRecoGrammar', 'SVP_5', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SWFEFormatTag', 'DISPID_SRStatus', 'SPVPRI_NORMAL',
    'Speech_Max_Word_Length', 'DISPID_SPELexicalForm', 'SINoSignal',
    'DISPID_SpeechRecoResultTimes', 'eLEXTYPE_USER_SHORTCUT',
    'ISpShortcut', 'SAFTGSM610_8kHzMono', 'SPSNoun',
    'DISPID_SpeechPhoneConverter', 'DISPID_SpeechRecoContextEvents',
    'SPEI_SOUND_START', 'SSSPTRelativeToStart', 'SPVPRI_OVER',
    'DISPID_SBSFormat', 'SPRECOGNIZERSTATUS',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SVEWord',
    'SpeechCategoryAudioOut', 'SPEI_REQUEST_UI',
    'SPINTERFERENCE_TOOFAST', 'SVESentenceBoundary',
    'DISPID_SLPSymbolic', 'DISPID_SGRSTType',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPCPhoneToId', 'SpeechGrammarTagDictation',
    'DISPID_SPPsItem', 'DISPID_SRSClsidEngine', 'DISPID_SRGReset',
    'ISpeechGrammarRules', 'DISPID_SRCEInterference',
    'DISPID_SVSLastBookmarkId', 'DISPID_SASCurrentDevicePosition',
    'SVP_8', 'SpeechRuleAttributes', 'SPWT_DISPLAY',
    'DISPID_SLGetWords', 'SVP_4', 'DISPID_SRGState',
    'DISPID_SASetState', 'SAFT48kHz8BitStereo', 'SPWORDPRONOUNCEABLE',
    'DISPID_SPRsItem', 'ISpGrammarBuilder', 'SPRST_NUM_STATES',
    'DISPID_SVSPhonemeId', 'SpeechPropertyNormalConfidenceThreshold',
    'SSFMOpenReadWrite', 'ISpeechLexiconPronunciation',
    'DISPID_SRRGetXMLErrorInfo', 'SVF_Emphasis', 'SGRSTTRule',
    'DISPID_SpeechRecoContext', 'SVEBookmark',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRCEBookmark',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SWFEBlockAlign', 'SPRS_ACTIVE_USER_DELIMITED',
    'SITooQuiet', 'ISpRecoResult', 'SPEI_SR_BOOKMARK',
    'SWPUnknownWordPronounceable', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SCSBaseStream', 'SAFT8kHz16BitStereo',
    'DISPID_SpeechPhraseInfo', 'SAFT32kHz16BitStereo',
    'DISPID_SPIRetainedSizeBytes', 'SAFT48kHz16BitMono',
    'ISpObjectTokenCategory', 'ISpeechCustomStream',
    'DISPID_SDKGetlongValue', 'SPGS_DISABLED',
    'SDA_One_Trailing_Space', 'DISPID_SLGetGenerationChange',
    'ISpeechLexiconPronunciations', 'SPINTERFERENCE',
    'SpeechCategoryPhoneConverters', 'SRTEmulated',
    'DISPID_SVEPhoneme', 'DISPID_SVSpeakStream', 'SVF_None',
    'DISPID_SGRSTPropertyId', 'eLEXTYPE_PRIVATE16',
    'DISPID_SOTDisplayUI', 'DISPID_SLGetPronunciations',
    'DISPID_SpeechAudioStatus', 'DISPID_SPEDisplayAttributes',
    'DISPID_SRCERecognition', 'SpeechAudioFormatType',
    'SpSharedRecognizer', 'DISPID_SPEDisplayText', 'DISPID_SPPId',
    'ISpEventSource', 'DISPID_SOTCreateInstance',
    'ISpeechGrammarRuleState', 'DISPID_SpeechPhraseElement',
    'SpeechRetainedAudioOptions', 'SpeechPropertyResponseSpeed',
    'IInternetSecurityManager', 'DISPID_SPIReplacements',
    'DISPID_SpeechLexiconWords', 'SAFT44kHz16BitMono',
    'DISPID_SVSInputSentenceLength', 'SpeechEmulationCompareFlags',
    'DISPID_SpeechAudioFormat', 'DISPID_SGRSTs_NewEnum',
    'SpeechBookmarkOptions', 'SpeechVoiceSpeakFlags',
    'SSFMCreateForWrite', 'SPRS_INACTIVE', 'ISpRecoGrammar',
    'DISPID_SABufferNotifySize', 'SpStreamFormatConverter',
    'SAFT12kHz16BitStereo', 'DISPID_SPRsCount', 'SDKLCurrentConfig',
    'DISPID_SPIGetText', 'DISPID_SMSAMMHandle', 'SPAUDIOSTATE',
    'ISpeechGrammarRule', 'SECFNoSpecialChars', 'SWTDeleted',
    'SREFalseRecognition', 'SPEI_RESERVED3', 'DISPID_SRRTLength',
    'SVP_18', 'SPAUDIOOPTIONS', 'DISPID_SGRClear',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SOTIsUISupported',
    'DISPID_SRAudioInput', 'DISPID_SPPBRestorePhraseFromMemory',
    'SVSFNLPMask', 'SVPNormal', 'Speech_StreamPos_RealTime',
    'DISPID_SASFreeBufferSpace', 'SpObjectTokenCategory',
    'SPSERIALIZEDRESULT', 'SVEAudioLevel', 'DISPID_SVAudioOutput',
    'SPXRO_Alternates_SML', 'SAFTCCITT_uLaw_44kHzStereo', 'SVP_21',
    'DISPID_SVEVoiceChange', 'SpeechStreamFileMode',
    'SPWAVEFORMATTYPE', 'ISpeechObjectToken', 'DISPID_SPPName',
    'SPWT_LEXICAL', 'SPVPRI_ALERT', 'DISPID_SDKEnumValues',
    'DISPID_SRGDictationLoad', 'eLEXTYPE_RESERVED6', 'SP_VISEME_3',
    'WAVEFORMATEX', 'SpeechSpecialTransitionType', 'SPRULESTATE',
    'SLOStatic', 'SPEI_RECOGNITION', 'ISpeechFileStream',
    'ISpeechPhoneConverter', 'SPEI_MAX_SR',
    'DISPID_SPEActualConfidence', 'eLEXTYPE_PRIVATE8',
    'DISPID_SOTCSetId', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPPChildren',
    'DISPID_SVSRunningState', 'eLEXTYPE_PRIVATE20', 'ISpStream',
    'SPPS_SuppressWord', 'SPRS_ACTIVE', 'SGDisplay',
    '_RemotableHandle', 'DISPID_SRGetFormat', 'DISPID_SLPType',
    'SP_VISEME_17', 'ISpMMSysAudio', 'DISPID_SAFGuid',
    'DISPID_SRCESoundStart', 'ISpeechAudioFormat', 'SRESoundEnd',
    'DISPID_SRCESoundEnd', 'DISPID_SRDisplayUI', 'SPEI_INTERFERENCE',
    'SPFILEMODE', 'SPPARTOFSPEECH', 'SpeechPropertyAdaptationOn',
    'ISpeechRecoResultDispatch', 'DISPID_SWFEExtraData',
    'SAFT24kHz16BitStereo', 'SPSERIALIZEDPHRASE',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SABufferInfo',
    'SDKLDefaultLocation', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPGS_EXCLUSIVE', 'ISpeechPhraseAlternate', 'SPWF_INPUT',
    'STCLocalServer', 'DISPID_SPPConfidence',
    'DISPID_SpeechMMSysAudio', 'SAFT32kHz8BitStereo',
    'DISPID_SOTGetAttribute', 'DISPID_SpeechLexiconWord',
    'SpeechLoadOption', 'DISPID_SRGetPropertyString', 'SP_VISEME_8',
    'DISPID_SOTs_NewEnum', 'DISPID_SGRSTRule', 'DISPID_SRCVoice',
    'SAFT22kHz16BitStereo', 'SAFTCCITT_uLaw_11kHzStereo',
    'SVSFNLPSpeakPunc', 'SRTStandard', 'SVEViseme',
    'SPEI_TTS_AUDIO_LEVEL', 'SVEVoiceChange',
    'DISPID_SDKGetBinaryValue', 'DISPID_SRCCmdMaxAlternates',
    'SAFT11kHz16BitStereo', 'DISPID_SLWPronunciations',
    'SRTExtendableParse', 'SAFTGSM610_44kHzMono', 'eLEXTYPE_PRIVATE6',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRCEStartStream',
    'SpeechCategoryVoices', 'ISpObjectWithToken', 'SRERecognition',
    'DISPID_SRAudioInputStream', 'SPFM_CREATE_ALWAYS', 'SGSExclusive',
    'SDTAudio', 'SpMMAudioEnum', 'SAFTCCITT_uLaw_11kHzMono',
    'SpPhoneConverter', 'ISpAudio', 'DISPID_SOTCGetDataKey',
    'SAFTDefault', 'DISPID_SRRAudio', 'DISPID_SPAsItem',
    'SPPHRASEELEMENT', 'SpeechAudioState',
    'DISPID_SRRDiscardResultInfo', 'SAFTADPCM_8kHzMono', 'SPPS_Noun',
    'DISPID_SGRsItem', 'SPEI_START_INPUT_STREAM',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPIDSPTSI_ActiveOffset',
    'SREStateChange', 'SPFM_CREATE', 'DISPID_SVSpeak',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpWaveFormatEx', 'SPXRO_SML', 'SPAUDIOSTATUS',
    'DISPID_SPISaveToMemory', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRRPhraseInfo', 'DISPID_SRCEAdaptation',
    ...
    'ISpXMLRecoResult', 'SpeechPropertyComplexResponseSpeed',
    'SPSHT_Unknown', 'DISPID_SOTCategory',
    'DISPID_SRSNumberOfActiveRules', 'SPEI_PHONEME',
    'tagSPPROPERTYINFO', 'STSF_CommonAppData',
    'DISPID_SPRuleNumberOfElements', 'SpPhoneticAlphabetConverter',
    'SpeechRunState', 'DISPID_SLPs_NewEnum', 'SPEVENT',
    'SpeechAudioProperties', 'DISPID_SpeechAudio',
    'DISPID_SRSAudioStatus', 'ISpEventSink', 'SPEI_MAX_TTS',
    'DISPID_SMSALineId', 'DISPID_SWFESamplesPerSec', 'SPAO_NONE',
    'SpCompressedLexicon', 'SpeechVoiceSkipTypeSentence', 'SVP_3',
    'DISPID_SPEPronunciation', 'DISPID_SPEEngineConfidence',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SASNonBlockingIO',
    'SP_VISEME_19', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SRGIsPronounceable', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRRRecoContext', 'SASStop', 'ISpeechRecoResultTimes',
    'DISPID_SPERetainedStreamOffset', 'ISpRecognizer3',
    'ISpeechLexiconWord', 'DISPID_SPRFirstElement',
    'eLEXTYPE_PRIVATE4', 'ISpeechObjectTokenCategory',
    'SpeechVisemeFeature', 'SPRECORESULTTIMES', 'SWTAdded',
    'DISPID_SPIAudioStreamPosition', 'IEnumString',
    'SPEI_WORD_BOUNDARY', 'SPVISEMES', 'SPPS_Interjection',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRCEEndStream',
    'DISPID_SMSADeviceId', 'DISPID_SPIElements',
    '__MIDL_IWinTypes_0009', 'SVEEndInputStream', 'STCInprocHandler',
    'SPAUDIOBUFFERINFO', 'DISPID_SPIStartTime',
    'DISPID_SPIAudioSizeTime', 'SASPause', 'SGLexicalNoSpecialChars',
    'SVP_10', 'DISPID_SpeechVoiceStatus', 'ISpPhrase', 'SP_VISEME_14',
    'DISPID_SVVolume', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SVEBookmark', 'SECFIgnoreWidth', 'SAFT44kHz16BitStereo',
    'DISPID_SpeechVoice', 'ISpeechWaveFormatEx', 'SDTDisplayText',
    'SPRULE', 'SRSInactive', 'SPEI_UNDEFINED', 'SPSTREAMFORMATTYPE',
    'SPPS_RESERVED1', 'SVPOver', 'DISPID_SRCResume',
    'DISPID_SRGSetTextSelection', 'DISPID_SVSLastBookmark',
    'DISPID_SRSetPropertyString', 'DISPID_SPPFirstElement',
    'DISPID_SPARecoResult', 'DISPID_SLPLangId', 'SREAllEvents',
    'SGDSActiveWithAutoPause', 'DISPID_SAFSetWaveFormatEx',
    'SVPAlert', 'SVP_6', 'DISPID_SVSInputWordLength',
    'SPINTERFERENCE_TOOQUIET', 'SpMMAudioIn', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SpeechFileStream', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SPPEngineConfidence', 'eLEXTYPE_PRIVATE17', 'SP_VISEME_0',
    'SP_VISEME_12', 'SpeechPartOfSpeech', 'ISpNotifySource',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SPRuleParent',
    'SPEI_RESERVED6', 'DISPID_SRCEAudioLevel', 'SAFT11kHz8BitStereo',
    'SpCustomStream', 'SVSFIsFilename', 'SRARoot',
    ...
    'SpFileStream', 'DISPID_SMSSetData', 'DISPID_SPRules_NewEnum',
    'DISPID_SDKSetLongValue', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SpeechDataKey', 'SP_VISEME_13', 'ISpeechPhraseProperty',
    'SpeechGrammarTagWildcard', 'SGRSTTWord',
    'DISPID_SWFEBitsPerSample', 'DISPID_SREmulateRecognition',
    'DISPID_SRCPause', 'ISpPhoneticAlphabetConverter',
    'ISpeechGrammarRuleStateTransition', 'SAFT24kHz8BitMono',
    'SPWT_PRONUNCIATION', 'SVP_16', 'SpInProcRecoContext',
    'SpResourceManager', 'DISPID_SRGetPropertyNumber',
    'SPPS_Noncontent', 'DISPID_SRGRecoContext', 'DISPID_SGRsCommit',
    'SpLexicon', 'SRAONone', 'SAFT11kHz16BitMono', 'DISPID_SOTCId',
    'DISPID_SOTCDefault', 'SVP_14', 'DISPID_SpeechGrammarRule',
    'SGRSTTTextBuffer', 'SECHighConfidence', 'SpeechAllElements',
    'DISPID_SVGetVoices', 'eLEXTYPE_APP', 'SECFDefault',
    'SP_VISEME_10', 'ISpeechMMSysAudio', 'SPWORDTYPE',
    'SRCS_Disabled', 'ISpSerializeState', 'DISPID_SGRSTNextState',
    'SRCS_Enabled', 'SRAImport', 'SVP_12', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechTokenIdUserLexicon',
    'SAFT48kHz16BitStereo',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPBO_TIME_UNITS', 'SPCT_DICTATION', 'DISPID_SRRGetXMLResult',
    'SVP_13', 'ISpeechResourceLoader', 'ISpeechPhraseInfo',
    'ISpObjectToken', 'SPAS_STOP', 'DISPID_SPACommit',
    'DISPID_SWFEAvgBytesPerSec', 'SpVoice', 'DISPID_SRRAlternates',
    'DISPID_SRCEPropertyNumberChange', 'SGDSActive', 'SVP_11',
    'ISpeechPhraseReplacement', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPINTERFERENCE_NOISE', 'ISpVoice', 'SSTTTextBuffer',
    'DISPID_SRSetPropertyNumber', 'SPRECOSTATE',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPIEngineId',
    'DISPID_SRRTTickCount', 'SGSEnabled', 'eLEXTYPE_USER',
    'DISPID_SPIAudioSizeBytes', 'SRAExport', 'DISPID_SVRate',
    'SP_VISEME_5', 'SPINTERFERENCE_NONE', 'SPFM_NUM_MODES',
    'DISPID_SPRText', 'ISpeechVoiceStatus',
    'SAFTCCITT_uLaw_44kHzMono', 'SRADynamic', 'SINoise',
    'SGRSTTWildcard', 'SPEI_SR_PRIVATE', 'SPRST_ACTIVE_ALWAYS',
    'SPWF_SRENGINE', 'SVSFParseAutodetect',
    'DISPID_SVESentenceBoundary', 'SpSharedRecoContext',
    'SpUnCompressedLexicon', 'SP_VISEME_20', 'DISPID_SDKDeleteValue',
    'SDA_No_Trailing_Space', 'SREInterference', 'SREAdaptation',
    'DISPID_SPRuleEngineConfidence', 'SPSUnknown', 'DISPID_SLWWord',
    'ISpeechBaseStream', 'SAFT24kHz16BitMono', 'eLEXTYPE_PRIVATE5',
    'DISPID_SpeechRecoResult2', 'SDTAlternates', 'DISPID_SRCBookmark',
    'Speech_Default_Weight', 'SREBookmark', 'SECFEmulateResult',
    'DISPID_SRGDictationSetState', 'DISPID_SOTsCount',
    'SPTEXTSELECTIONINFO', 'SLODynamic', 'eLEXTYPE_RESERVED10',
    'SPRST_ACTIVE', 'SAFTNonStandardFormat', 'SAFTADPCM_22kHzStereo',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRRSpeakAudio',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechObjectToken',
    'DISPID_SWFEChannels', 'SpMemoryStream', 'SSTTDictation',
    'SPDATAKEYLOCATION', 'SpeechGrammarTagUnlimitedDictation',
    '_ISpeechRecoContextEvents', 'eLEXTYPE_PRIVATE18',
    'DISPIDSPTSI_ActiveLength', 'SAFTADPCM_8kHzStereo',
    'SDA_Two_Trailing_Spaces', 'SPDKL_DefaultLocation', 'SDTAll',
    'SREPhraseStart', 'SVSFParseSapi', 'DISPID_SpeechLexicon',
    'SPLO_DYNAMIC', 'SVEStartInputStream',
    ...
    'DISPID_SPAs_NewEnum', 'SpeechTokenContext', 'SPSHORTCUTPAIRLIST',
    'DISPID_SpeechPhraseAlternate', 'SPCS_DISABLED',
    'DISPID_SVResume', 'DISPID_SVVoice', 'SPSEMANTICFORMAT',
    'DISPID_SLWsItem', 'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPRuleId',
    'SASRun', 'DISPID_SRRTOffsetFromStart',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SGRsFindRule',
    'SAFTGSM610_11kHzMono', 'SLTApp', 'DISPID_SPEAudioStreamOffset',
    'SRTReSent', 'DISPID_SPRuleConfidence',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SGRSTsItem',
    'eLEXTYPE_PRIVATE2', 'SpeechVoiceEvents', 'SPAO_RETAIN_AUDIO',
    'SRADefaultToActive', 'ISpRecoGrammar2', 'DISPID_SADefaultFormat',
    'SDKLLocalMachine', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SVWaitUntilDone', 'DISPID_SVStatus',
    'SAFT16kHz8BitStereo', 'DISPID_SPAPhraseInfo',
    'SAFT32kHz16BitMono', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SOTDataKey', 'SREStreamStart', 'SP_VISEME_18', 'SFTInput',
    'DISPID_SGRAddState', 'SPPHRASE', 'DISPID_SVPause',
    'SPPS_Function', 'SAFTCCITT_uLaw_8kHzMono',
    'SWPUnknownWordUnpronounceable', 'STCInprocServer',
    'DISPID_SpeechObjectTokens', 'eLEXTYPE_RESERVED9', 'SP_VISEME_1',
    'SAFT16kHz8BitMono', 'ISpeechRecognizerStatus',
    'DISPID_SRCRetainedAudioFormat',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SAVolume',
    'SAFT12kHz8BitMono', 'SPAR_Unknown', 'SpNullPhoneConverter',
    'DISPID_SLWsCount', 'SPRECOCONTEXTSTATUS', 'SPVPRIORITY',
    'SPPS_Verb', 'SpeechInterference', 'DISPID_SpeechCustomStream',
    'SPEI_TTS_PRIVATE', 'SpeechEngineProperties',
    'DISPID_SDKSetStringValue', 'SpeechTokenKeyFiles',
    'SVSFPersistXML', 'ISpPhoneticAlphabetSelection',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SPEAudioSizeTime',
    'DISPID_SPRuleName', 'DISPID_SGRSTWeight', 'DISPID_SDKDeleteKey',
    'SPEI_SENTENCE_BOUNDARY', 'SVP_17', 'SPPS_NotOverriden',
    'SPLO_STATIC', 'DISPID_SRCERecognizerStateChange',
    'SPLOADOPTIONS', 'SAFT48kHz8BitMono', 'SpeechWordType',
    'DISPID_SOTSetId', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'IStream',
    'DISPID_SpeechRecognizer', 'SAFT22kHz16BitMono',
    'SPWORDPRONUNCIATION', 'DISPID_SpeechGrammarRules',
    'DISPID_SPRs_NewEnum', 'SP_VISEME_9', 'ISpNotifySink',
    'SpeechLexiconType', 'SAFT24kHz8BitStereo',
    'SpeechTokenKeyAttributes', 'eLEXTYPE_PRIVATE12',
    'SpeechCategoryRecognizers', 'DISPID_SpeechRecoResult',
    'SREAudioLevel', 'ISpeechPhraseRule', 'SPWORDPRONUNCIATIONLIST',
    'SSFMCreate', 'ISpeechRecognizer', 'SAFTCCITT_ALaw_8kHzStereo',
    'ISpDataKey', 'SPSEMANTICERRORINFO', 'SBONone',
    'eLEXTYPE_PRIVATE15', 'SPPS_Unknown', 'DISPID_SGRName',
    'SRSActive', 'eLEXTYPE_PRIVATE14', 'SpPhraseInfoBuilder',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SRRTimes',
    'SVSFPurgeBeforeSpeak', 'SITooFast', 'SPEI_MIN_TTS',
    'DISPIDSPTSI_SelectionLength', 'SPEI_RESERVED1',
    'SPINTERFERENCE_TOOSLOW', 'SVSFDefault', 'DISPID_SPPValue',
    'SPEI_PHRASE_START', 'DISPID_SOTGetDescription',
    'DISPID_SPRulesCount', 'SPEI_RECO_STATE_CHANGE', 'SRATopLevel',
    'SREHypothesis', 'LONG_PTR', 'SREPropertyNumChange',
    'DISPID_SOTId', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SPIRule', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SRCCreateGrammar', 'SPCT_COMMAND', 'ISpPhoneConverter',
    'DISPID_SRGetRecognizers', 'DISPID_SLWs_NewEnum',
    'SPDKL_LocalMachine', 'DISPID_SpeechBaseStream',
    'DISPID_SRCSetAdaptationData', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SPERequiredConfidence', 'DISPID_SFSOpen', 'SFTSREngine',
    'DISPID_SGRInitialState', 'SPVOICESTATUS', 'SGSDisabled',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SPEsItem',
    'DISPID_SGRSTText', 'SAFT16kHz16BitMono',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SVEEnginePrivate',
    'eLEXTYPE_RESERVED8', 'DISPID_SLGenerationId', 'SPEI_ADAPTATION',
    'DISPID_SBSWrite', 'DISPID_SPAStartElementInResult',
    'SSSPTRelativeToEnd', 'eLEXTYPE_PRIVATE11',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPIDSPTSI',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SpeechGrammarRuleState', 'SDTRule', 'eLEXTYPE_PRIVATE9',
    'ISpRecognizer', 'SRSActiveAlways', 'DISPID_SVSLastResult',
    'ISpeechAudio', 'DISPID_SPIProperties', 'DISPID_SRRTStreamTime',
    'DISPID_SDKGetStringValue', 'SPFM_OPEN_READONLY',
    'SDTReplacement', 'SPRST_INACTIVE', 'SPSHT_OTHER',
    'DISPID_SGRSRule', 'SpeechAddRemoveWord', 'DISPID_SABIBufferSize',
    'SECLowConfidence', 'SVP_15', 'SpeechFormatType',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SOTRemove',
    'DISPID_SGRsAdd', 'SASClosed', 'DISPID_SRCVoicePurgeEvent',
    'SpeechRecoContextState', 'SGRSTTDictation',
    'SpeechGrammarRuleStateTransitionType', 'ISpeechPhraseAlternates',
    'ISpRecoContext', 'SGPronounciation', 'ISpeechLexicon',
    'SDTPronunciation', 'eWORDTYPE_DELETED', 'SPEI_SR_RETAINEDAUDIO',
    'SDA_Consume_Leading_Spaces', 'SpTextSelectionInformation',
    'SAFTADPCM_44kHzStereo', 'DISPID_SOTMatchesAttributes',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRProfile',
    'SpeechAudioFormatGUIDText', 'SPSModifier',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPSMF_UPS',
    'DISPID_SGRSTPropertyName', 'ISpeechAudioStatus', 'SpMMAudioOut',
    'SECFIgnoreKanaType', 'DISPID_SLWLangId', 'SpeechGrammarWordType',
    'DISPID_SpeechPhraseElements', 'SBOPause', 'SPAS_CLOSED',
    'SPSLMA', 'DISPID_SOTGetStorageFileName',
    'DISPID_SVGetAudioInputs', 'SpeechCategoryAppLexicons',
    'SRAInterpreter', 'DISPID_SpeechMemoryStream',
    'SPADAPTATIONRELEVANCE', 'SPEI_MIN_SR', 'SVP_7',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SVSCurrentStreamNumber',
    'ISpeechRecoResult2', 'DISPID_SLPPartOfSpeech', 'SPSNotOverriden',
    'DISPID_SLPPhoneIds', 'IInternetSecurityMgrSite',
    'SPEI_RESERVED2', 'SP_VISEME_11', 'SPCS_ENABLED', 'SP_VISEME_4',
    'DISPID_SPPsCount', 'DISPID_SPEAudioTimeOffset', 'DISPID_SRState',
    'DISPID_SGRSTransitions', 'DISPID_SVSInputSentencePosition',
    'DISPID_SGRAttributes', 'DISPID_SRCRetainedAudio',
    'DISPID_SRGSetWordSequenceData', 'SVP_2', 'DISPID_SABIEventBias',
    'SVP_1', 'DISPID_SLWType', 'SPAR_High', 'DISPID_SGRsDynamic',
    'DISPID_SpeechPhraseProperties', 'ISpStreamFormat',
    'SP_VISEME_16', 'DISPID_SVSInputWordPosition',
    'DISPID_SGRAddResource', 'SGRSTTEpsilon', 'SP_VISEME_6',
    'SP_VISEME_15', 'SPBINARYGRAMMAR', 'DISPID_SDKOpenKey',
    'SpeechGrammarState', 'SpeechEngineConfidence',
    'SWPKnownWordPronounceable', 'SPEI_PROPERTY_STRING_CHANGE',
    'SRTAutopause', 'DISPID_SLRemovePronunciation', 'SPAS_RUN',
    'DISPIDSPTSI_SelectionOffset', 'SVSFParseSsml', 'SPBO_AHEAD',
    'DISPID_SVEventInterests', 'DISPID_SVEViseme', 'SpeechRuleState',
    'DISPID_SRRSaveToMemory', 'SpShortcut', 'SPCT_SLEEP',
    'SVSFIsNotXML', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SRGRules', 'eLEXTYPE_PRIVATE10',
    'DISPID_SPPNumberOfElements', '_SPAUDIOSTATE',
    'DISPID_SPPs_NewEnum', 'SPXMLRESULTOPTIONS', 'SRERequestUI',
    'SpObjectToken', 'DISPID_SPIGrammarId', 'SPEI_FALSE_RECOGNITION',
    'SAFTADPCM_11kHzStereo', 'SRERecoOtherContext', 'SITooSlow',
    'SRAORetainAudio', 'SVSFlagsAsync', 'SPEI_TTS_BOOKMARK',
    'DISPID_SVGetProfiles', 'SPWORD', 'SVP_0',
    'SpeechRecognitionType', 'SPBO_NONE', 'DISPID_SpeechPhraseRules',
    'ISpRecognizer2', 'SVEPhoneme', 'SPDKL_CurrentUser',
    'DISPID_SAFType', 'SPPHRASERULE', 'SAFTADPCM_22kHzMono',
    'SAFTGSM610_22kHzMono', 'DISPID_SPEsCount',
    ...
    'DISPID_SPIEnginePrivateData', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPEI_VOICE_CHANGE', 'SECFIgnoreCase', 'SPEI_END_INPUT_STREAM',
    'ISpPhraseAlt', 'DISPID_SBSSeek', 'SpStream',
    'ISpeechXMLRecoResult', 'SAFT11kHz8BitMono',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPDKL_CurrentConfig',
    'DISPID_SRGCmdLoadFromResource', 'SRESoundStart',
    'DISPID_SASState', 'ISpeechPhraseProperties', 'STCRemoteServer',
    'DISPID_SVEStreamStart', 'SPEI_VISEME',
    'DISPID_SLRemovePronunciationByPhoneIds', 'STSF_AppData',
    'DISPID_SpeechVoiceEvent', 'SLTUser', 'SPEI_START_SR_STREAM',
    'ISpeechRecoContext', 'SPLEXICONTYPE',
    'DISPID_SRGCmdLoadFromFile', 'ISpStreamFormatConverter',
    'SPAR_Low', 'DISPIDSPRG', 'SPEI_END_SR_STREAM', 'DISPID_SBSRead',
    'ISpeechPhraseElement', 'SPFM_OPEN_READWRITE',
    'DISPID_SRIsShared', 'eLEXTYPE_PRIVATE1', 'SpeechTokenValueCLSID',
    'SGLexical', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SAFT8kHz8BitStereo', 'DISPID_SAEventHandle',
    'eLEXTYPE_LETTERTOSOUND', 'eWORDTYPE_ADDED', 'DISPID_SGRsCount',
    'SpeechCategoryAudioIn', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRCEventInterests', '_ISpeechVoiceEvents', 'SRSEDone',
    'ISpeechLexiconWords', 'SGDSInactive', 'SPEI_HYPOTHESIS',
    'SREStreamEnd', 'SpNotifyTranslator', 'DISPID_SLPsItem',
    'ISpeechMemoryStream', 'DISPID_SRRSetTextFeedback',
    'DISPID_SPRulesItem', 'SPCT_SUB_DICTATION', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRCRecognizer', 'DISPID_SPPParent', 'SPAR_Medium',
    'SpeechWordPronounceable', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SRCRequestedUIType', 'SAFT44kHz8BitStereo',
    'SpeechTokenShellFolder', 'SpeechPropertyHighConfidenceThreshold',
    'SAFTCCITT_ALaw_44kHzMono', 'SpeechDictationTopicSpelling',
    'ISpeechObjectTokens', 'STCAll',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SpeechAudioBufferInfo', 'STSF_LocalAppData',
    'SDTLexicalForm', 'DISPID_SRCEPhraseStart',
    'DISPID_SpeechLexiconProns', 'SINone', 'ISpeechRecoResult',
    'SAFT44kHz8BitMono', 'SpeechStreamSeekPositionType',
    'eLEXTYPE_PRIVATE3', 'SP_VISEME_21', 'SAFTExtendedAudioFormat',
    'SpeechVoicePriority', 'DISPID_SRCAudioInInterferenceStatus',
    'SAFTADPCM_11kHzMono', 'ISpeechVoice', 'SPINTERFERENCE_NOSIGNAL',
    'tagSTATSTG', 'SAFTText', 'ISpeechPhraseReplacements',
    'DISPID_SGRSAddRuleTransition', 'SpeechRecoProfileProperties',
    'DISPID_SVIsUISupported', 'DISPID_SPILanguageId',
    'DISPID_SDKCreateKey', 'SVSFUnusedFlags', 'SPSInterjection',
    'SPCT_SUB_COMMAND', 'SAFT12kHz8BitStereo', 'ISpNotifyTranslator',
    'SSTTWildcard', 'SAFTNoAssignedFormat', 'SpeechVisemeType',
    'SpeechRecognizerState', 'SpeechDisplayAttributes',
    'SPPS_RESERVED4', 'SAFT32kHz8BitMono', 'eLEXTYPE_RESERVED7'
]

_check_version('1.2.0', 1680636646.224737)
